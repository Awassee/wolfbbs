...
- PRD-04: In progress (message ACS+pointers plus file indexing/tag/ratings/queue/ticket baseline shipped; message networking, built-in mods pack, and final download manager parity remain).
