...
seed_web_e2e_credentials() {
  ...
  export WOLFBBS_E2E_USER_HANDLE="${WOLFBBS_E2E_USER_HANDLE:-$default_user_handle}"
  export WOLFBBS_E2E_USER_PASSWORD="${WOLFBBS_E2E_USER_PASSWORD:-$default_user_password}"
  export WOLFBBS_E2E_IRC_NICK="${WOLFBBS_E2E_IRC_NICK:-$WOLFBBS_E2E_USER_HANDLE}"
