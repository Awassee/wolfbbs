...
run_static_checks() {
  ...
  must "INS-005" "required installer flags are present" bash -c "./install.sh --help | grep -Eiq -- '--prefix' && ./install.sh --help | grep -Eiq -- '--ssh-port' && ./install.sh --help | grep -Eiq -- '--web-port' && ./install.sh --help | grep -Eiq -- '--irc-port' && ./install.sh --help | grep -Eiq -- '--upgrade' && ./install.sh --help | grep -Eiq -- '--status' && ./install.sh --help | grep -Eiq -- '--uninstall' && ./install.sh --help | grep -Eiq -- '--force'"
