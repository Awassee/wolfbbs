...
- [Release v1.1.24 notes](docs/releases/v1.1.24.md)
...
WolfBBS is currently shipped as `v1.1.24` with:

- clean package generation via `scripts/package-dist.sh --clean --version v1.1.24`
- checksum + manifest output per bundle under `dist/v1.1.24/`
...
Build clean `v1.1.24` distro bundles locally:
