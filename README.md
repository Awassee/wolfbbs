...
- [Release v1.1.26 notes](docs/releases/v1.1.26.md)
...
WolfBBS is currently shipped as `v1.1.26` with:

- clean package generation via `scripts/package-dist.sh --clean --version v1.1.26`
- checksum + manifest output per bundle under `dist/v1.1.26/`
...
Build clean `v1.1.26` distro bundles locally:

```bash
scripts/package-dist.sh --clean --version v1.1.26 \
