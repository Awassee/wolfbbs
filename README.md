...
- [Release v2.1.5 notes](docs/releases/v2.1.5.md)
...
WolfBBS is currently shipped as `v2.1.5` with:

- clean package generation via `scripts/package-dist.sh --clean --version v2.1.5`
- checksum + manifest output per bundle under `dist/v2.1.5/`
...
Build clean `v2.1.5` distro bundles locally:

```bash
scripts/package-dist.sh --clean --version v2.1.5 \
