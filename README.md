...
- [Release v2.1.8 notes](docs/releases/v2.1.8.md)
...
WolfBBS is currently shipped as `v2.1.8` with:

- clean package generation via `scripts/package-dist.sh --clean --version v2.1.8`
- checksum + manifest output per bundle under `dist/v2.1.8/`
...
Build clean `v2.1.8` distro bundles locally:

```bash
scripts/package-dist.sh --clean --version v2.1.8 \
