...
- [Release v1.1.23 notes](docs/releases/v1.1.23.md)
...
WolfBBS is currently shipped as `v1.1.23` with:

- clean package generation via `scripts/package-dist.sh --clean --version v1.1.23`
- checksum + manifest output per bundle under `dist/v1.1.23/`
...
Build clean `v1.1.23` distro bundles locally:

```bash
scripts/package-dist.sh --clean --version v1.1.23 \
