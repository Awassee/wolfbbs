...
- [Release v1.1.25 notes](docs/releases/v1.1.25.md)
...
WolfBBS is currently shipped as `v1.1.25` with:

- clean package generation via `scripts/package-dist.sh --clean --version v1.1.25`
- checksum + manifest output per bundle under `dist/v1.1.25/`
...
Build clean `v1.1.25` distro bundles locally:

```bash
scripts/package-dist.sh --clean --version v1.1.25 \
